# Generated by Django 3.1.1 on 2020-12-02 16:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(choices=[('true', 'Открытый'), ('false', 'Закрытый')], default='true', max_length=15, verbose_name='Доступность')),
                ('image', models.ImageField(blank=True, upload_to=testing_system.utilities.course_image_path, verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_form', models.TextField(db_index=True, help_text='Шаблон формы учителя', max_length=4000, verbose_name='Необходимый шаблон класса')),
                ...
                ('reference_solution', models.TextField(db_index=True, help_text='Правильное решение', max_length=4000, verbose_name='Правильное решение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, upload_to=testing_system.utilities.user_directory_path, verbose_name='Загрузка решения')),
